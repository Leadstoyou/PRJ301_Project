            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href="#addNewFood"  class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Food</span></a>                        </div>
                    </div>
                </div>
                    ...
                    <tbody>
                        <c:forEach items="${listPage}" var="o">
                            <tr>
                                ...
                                <td>${o.price}</td>
                                <td>
                                    <a href="loadFood?fid=${o.id}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a href="delete?fid=${o.id}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#10008;</i></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
