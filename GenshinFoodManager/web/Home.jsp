                        ...
                        <div class="hero__search">
                            ...
                            <div class="hero__search__phone">
                                <div class="hero__search__phone__icon">
                                    ...
                                    <a href='https://www.facebook.com/vaycanh.thien/'><i class="fa fa-phone"></i></a>
                            ...
                            <div class="featured__item">
                                <div class="featured__item__pic set-bg" data-setbg="${o.image}">
                                    <ul class="featured__item__pic__hover">
                                        <li><a href="foodlike?fid=${o.id}"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="foodaddtocart?fid=${o.id}"><i class="fa fa-shopping-cart"></i></a></li>
                                    </ul>
                                </div>
